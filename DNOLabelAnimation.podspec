#
#  Be sure to run `pod spec lint DNOLabelAnimation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Danyow.Ed" => "i.zuucol@gmail.com" }
  # Or just: s.author    = "Danyow.Ed"
  # s.authors            = { "Danyow.Ed" => "i.zuucol@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Danyow.Ed"
